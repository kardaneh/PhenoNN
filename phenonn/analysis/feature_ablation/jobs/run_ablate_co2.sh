#!/usr/bin/env bash
#SBATCH --job-name=abl_co2
#SBATCH --output=/net/nfs/ssd2/sbarbu/PhenoNN/study_ablate_co2_%j.out
#SBATCH --error=/net/nfs/ssd2/sbarbu/PhenoNN/study_ablate_co2_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
