#!/usr/bin/env bash
#SBATCH --job-name=abl_ssrd_sum
#SBATCH --output=/net/nfs/ssd2/sbarbu/PhenoNN/study_ablate_ssrd_sum_%j.out
#SBATCH --error=/net/nfs/ssd2/sbarbu/PhenoNN/study_ablate_ssrd_sum_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
