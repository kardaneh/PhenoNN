#!/usr/bin/env bash
#SBATCH --job-name=abl_Tmean
#SBATCH --output=/net/nfs/ssd2/sbarbu/PhenoNN/study_ablate_Tmean_%j.out
#SBATCH --error=/net/nfs/ssd2/sbarbu/PhenoNN/study_ablate_Tmean_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
