#!/usr/bin/env bash
#SBATCH --job-name=abl_baseline
#SBATCH --output=/net/nfs/ssd2/sbarbu/PhenoNN/study_baseline_%j.out
#SBATCH --error=/net/nfs/ssd2/sbarbu/PhenoNN/study_baseline_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
