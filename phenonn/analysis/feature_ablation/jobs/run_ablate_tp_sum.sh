#!/usr/bin/env bash
#SBATCH --job-name=abl_tp_sum
#SBATCH --output=/net/nfs/ssd2/sbarbu/PhenoNN/study_ablate_tp_sum_%j.out
#SBATCH --error=/net/nfs/ssd2/sbarbu/PhenoNN/study_ablate_tp_sum_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
