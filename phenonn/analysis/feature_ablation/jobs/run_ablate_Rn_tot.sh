#!/usr/bin/env bash
#SBATCH --job-name=abl_Rn_tot
#SBATCH --output=/net/nfs/ssd2/sbarbu/PhenoNN/study_ablate_Rn_tot_%j.out
#SBATCH --error=/net/nfs/ssd2/sbarbu/PhenoNN/study_ablate_Rn_tot_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
