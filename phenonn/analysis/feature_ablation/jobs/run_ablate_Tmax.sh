#!/usr/bin/env bash
#SBATCH --job-name=abl_Tmax
#SBATCH --output=/net/nfs/ssd2/sbarbu/PhenoNN/study_ablate_Tmax_%j.out
#SBATCH --error=/net/nfs/ssd2/sbarbu/PhenoNN/study_ablate_Tmax_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
