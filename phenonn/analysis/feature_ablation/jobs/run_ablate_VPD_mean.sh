#!/usr/bin/env bash
#SBATCH --job-name=abl_VPD_mean
#SBATCH --output=/net/nfs/ssd2/sbarbu/PhenoNN/study_ablate_VPD_mean_%j.out
#SBATCH --error=/net/nfs/ssd2/sbarbu/PhenoNN/study_ablate_VPD_mean_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
